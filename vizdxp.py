...
main1 = "<div><span class='fontgreen'>vizdxp is an open-source visualization tool that helps in quick exploratory data analysis and lets user to report findings as an application\
\
</span></div>"
...
<p>vizdxp is an open-source web app designed via streamlit weaved with plotly and seaborn libraries. <span class='fontgreen'><b>Its incredibly Simple - Just drag & drop any csv in the left pane and explore the data visually.</b></span> By default the application will figure out better visualization based on user selections. \
Feel free to customize as needed. </p>

<b>Keys</b>
- **Simple** and quick for any <span class='fontgreen'>**Exploratory Data Analysis**</span>
- Create interactive <span class='fontgreen'>**Dashboard web app within minutes**</span> from any csv and share the findings
- <span class='fontgreen'>**Deploy**</span> it as a web application in your own workstations too
- By <span class='fontgreen'>**Default**</span> - chart types and aggregations are applied based on columns selected by user, null rows are removed, Date fields are converted to multiple subfields
- Highly <span class='fontgreen'>**Customizable**</span>
- No more static reports<br>

<b>Install vizdxp python package in your own environment and try it</b>
- pip install vizdxp
- python -m vizdxp
"""
...
def main():
    ...
    if page == 'Getting started':
        ...
        st.markdown("*Please raise any feature requests, notify issues in [github](https://github.com/Vinothsuku/vizdxp)*", unsafe_allow_html=True)
        st.sidebar.markdown("")
        st.sidebar.markdown("")
        ...
        st.sidebar.markdown("Github [repo](https://github.com/Vinothsuku/vizdxp)", unsafe_allow_html=True)
    if df is not None:
        df.seek(0)
